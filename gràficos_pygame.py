...
while 1:
    ...
    # Ciclo para la detecciòn del juego
    for event in pygame.event.get():
        # Si se hace click sobre el botòn de cerrar la ventana, el juego termina
    ...
    # Dibujar formas con el mòdulo pygame.drawio

    # Dibujar una lìnea 
    pygame.draw.line(ventana, rojo, (100,100),(300,300))
    pygame.draw.line(ventana, rojo,(100,300), (300,100))

    # Dibujar una lìnea discontinua
    # True: crea un polìgono 
    ...
    # Dibujar un rectàngulo 
    # Rectangulo relleno, ubicado e la coordenada esquina sup. izq. (200,200), y de anchi 200 y altura 100
    ...
    # Texto
    # Fuente de texto tipo Arial, tamaño 35, negrilla y cursiva.
    fuente_arial = pygame.font.SysFont("Arial", 35, 1, 1)
    texto = fuente_arial.render("Sistema Guanenta", 1, blanco)
